...
//    private final ExchangeRateService exchangeRateService;
    ...
    public Account createAccount(AccountDto accountDto, User user) throws Exception {
        long accountNumber;
        try {
          //Prevents the same user from creating multiple accounts with the same currency code
        ...
        //Account.builder() likha hai na? iska matlab hai ye Builder pattern use ho raha hai, jisse object banana easy aur readable hota hai.
